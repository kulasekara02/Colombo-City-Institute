...
{
    public partial class AssignmentStatus : Form
    {
        ...
        private void AssignmentStatus_Load(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT assignmentName,Status FROM tbl_assignment WHERE studentId=@studentId";
