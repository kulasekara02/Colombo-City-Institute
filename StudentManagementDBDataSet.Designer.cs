...
namespace Student_Management_System {
    ...
    public partial class StudentManagementDBDataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_usersDataTable : global::System.Data.TypedTableBase<tbl_usersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public tbl_usersRow Addtbl_usersRow(string userName, string userPassword, string userType, System.DateTime addedDate) {
...
namespace Student_Management_System.StudentManagementDBDataSetTableAdapters {
    ...
    public partial class tbl_usersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbl_users] WHERE (([id] = @Original_id) AND ((@IsNull_userName = 1 AND [userName] IS NULL) OR ([userName] = @Original_userName)) AND ((@IsNull_userPassword = 1 AND [userPassword] IS NULL) OR ([userPassword] = @Original_userPassword)) AND ((@IsNull_userType = 1 AND [userType] IS NULL) OR ([userType] = @Original_userType)) AND ((@IsNull_addedDate = 1 AND [addedDate] IS NULL) OR ([addedDate] = @Original_addedDate)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbl_users] ([userName], [userPassword], [userType], [addedDate" +
                "]) VALUES (@userName, @userPassword, @userType, @addedDate);\r\nSELECT id, userNam" +
                "e, userPassword, userType, addedDate FROM tbl_users WHERE (id = SCOPE_IDENTITY()" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_users] SET [userName] = @userName, [userPassword] = @userPassword, [userType] = @userType, [addedDate] = @addedDate WHERE (([id] = @Original_id) AND ((@IsNull_userName = 1 AND [userName] IS NULL) OR ([userName] = @Original_userName)) AND ((@IsNull_userPassword = 1 AND [userPassword] IS NULL) OR ([userPassword] = @Original_userPassword)) AND ((@IsNull_userType = 1 AND [userType] IS NULL) OR ([userType] = @Original_userType)) AND ((@IsNull_addedDate = 1 AND [addedDate] IS NULL) OR ([addedDate] = @Original_addedDate)));
SELECT id, userName, userPassword, userType, addedDate FROM tbl_users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Student_Management_System.Properties.Settings.Default.StudentManagementDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, userName, userPassword, userType, addedDate FROM dbo.tbl_users";
        ...
        public virtual int Fill(StudentManagementDBDataSet.tbl_usersDataTable dataTable) {
        ...
        public virtual StudentManagementDBDataSet.tbl_usersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            StudentManagementDBDataSet.tbl_usersDataTable dataTable = new StudentManagementDBDataSet.tbl_usersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(StudentManagementDBDataSet.tbl_usersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_userName, string Original_userPassword, string Original_userType, global::System.Nullable<global::System.DateTime> Original_addedDate) {
        ...
        public virtual int Insert(string userName, string userPassword, string userType, global::System.Nullable<global::System.DateTime> addedDate) {
            if ((userName == null)) {
            ...
            if ((addedDate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(addedDate.Value));
            }
            else {
        ...
        public virtual int Update(string userName, string userPassword, string userType, global::System.Nullable<global::System.DateTime> addedDate, int Original_id, string Original_userName, string Original_userPassword, string Original_userType, global::System.Nullable<global::System.DateTime> Original_addedDate, int id) {
            if ((userName == null)) {
            ...
            if ((addedDate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(addedDate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string userName, string userPassword, string userType, global::System.Nullable<global::System.DateTime> addedDate, int Original_id, string Original_userName, string Original_userPassword, string Original_userType, global::System.Nullable<global::System.DateTime> Original_addedDate) {
            return this.Update(userName, userPassword, userType, addedDate, Original_id, Original_userName, Original_userPassword, Original_userType, Original_addedDate, Original_id);
        }
    }
